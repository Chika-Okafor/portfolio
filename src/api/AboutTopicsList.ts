...
export interface IAboutTopics {
  headerText: string;
  bodyText: string;
}

export const AboutTopicsList: IAboutTopics[] = [
  {
    headerText: "Who am I and what do I do?",
    bodyText:
  ...
  {
    headerText: "When did I write my first line of code?",
    bodyText:
      "I wrote my first line of code in 2011 when I was eighteen years old. I wasn't a genius coder or anything like that, I just played around with HTML and CSS designing a cloud storage for my files that had more blinking click here emojis than I could counto",
  },
  {
    headerText: "How did I learn to code?",
    bodyText:
  ...
  {
    headerText: "How did I discover my passion for coding?",
    bodyText:
  ...
  {
    headerText: "What academic qualifications do I have?",
    bodyText:
  ...
  {
    headerText: "Why did I make the switch to tech?",
    bodyText:
  ...
  {
    headerText: "Who I am and what I do",
    bodyText:
